    ...
    public class ApplicationUsersController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            model = _userManager.Users.Select(u => new UserListViewModel
            {
                ...
                UserClaims = u.Claims.Any() ? _context.UserClaims.Where(r => r.UserId == u.Id).Select(r => r.ClaimValue.ToString()).ToList() : null,
                PuestosTrabajoList = u.PuestosTrabajo.Any() ? u.PuestosTrabajo.Select(p => p.Oficina.Name).ToList() : null
            }).ToList();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(applicationRole != null)
                    {
                        ...
                        {
                            _logger.LogInformation("The new user has been added successfully.");
...
//        [Authorize(Policy = "Usuarios")]
        ...
        public async Task<IActionResult> EditUser(string id, EditUserViewModel model)
        {
            ...
            {
                ApplicationUser applicationUser = await _userManager.FindByIdAsync(id);
                if (applicationUser != null && applicationUser.Email != "admin@contabilidadlosmuermos.cl")
                {
